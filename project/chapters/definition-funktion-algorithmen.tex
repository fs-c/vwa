...
Die Begrifflichkeit \enquote{Sortieralgorithmus} wird in \prettyref{sec:sorting-algorithms-definition} definiert. Anhand eines Beispielalgorithmus, dem \proc{Insertion-Sort}, wird die Arbeitsweise von Algorithmen, und insbesondere von Sortieralgorithmen, dargestellt.

In \prettyref{sec:algo-effizienz} wird eine Definition des Effizienzbegriffs im Kontext von Algorithmen präsentier.
...
\footnotetext{Vgl. beispielsweise die diversen Definitionen der verwendeten Pseudocode-Varianten in \cite[5]{hsr1997}, \cite[20ff]{clrs2001} und \cite[33ff]{ahu1974}, die jeweils an den Verwendungskontext angepasst sind.}
