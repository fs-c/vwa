...
Diese Anforderungen erfüllt das \emph{benchmark}-Programm bzw. der Code in \crMain. Standardmäßig erstellt es einen Ordner \emph{out} und befüllt diesen mit gesammelten Daten. Für jede mögliche Kombination aus Algorithmus und Eingabeart wird eine Tabelle mit Untermengengrößen und Zeitangaben erstellt, siehe \prettyref{fig:benchmark-file-structure}.
