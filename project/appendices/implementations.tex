...
\begin{lstlisting}[float, label=lst:insertion, caption={Implementation des \emph{insertionsort}.}]
...
\begin{lstlisting}[float, label=lst:merge, caption={Implementation des \emph{mergesort}.}]
